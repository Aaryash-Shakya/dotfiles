...
export PATH="/home/aaryash-u/.nvm/versions/node/v20.16.0/bin:$PATH"

# JavaFX
export PATH_TO_FX=/opt/javafx-sdk-22.0.2/lib
...
# To run autojump script on startup
. /usr/share/autojump/autojump.sh

# To hide node_modules from fzf
...
# For pure theme github.com/sindresorhus/pure
...
alias javarun='f() { class_name="$1"; if [[ "$class_name" == *.java ]]; then class_name="${class_name%.java}"; fi; javac "$class_name.java" && java "$class_name"; }; f'
